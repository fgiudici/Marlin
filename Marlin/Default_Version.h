...
#if true
#define SHORT_BUILD_VERSION "1.1.0-RC3-fgiudici-hotbed-alpha0"
#define DETAILED_BUILD_VERSION "1.1.0-RC3-fgiudici-hotbed Experimental Hotbed Mod (with swapped X axes)"
#define STRING_DISTRIBUTION_DATE "2021-01-12 12:00"
// It might also be appropriate to define a location where additional information can be found
#define SOURCE_CODE_URL  "local"
#endif
